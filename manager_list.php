...
<div class="container mx-auto mt-10">
    <h2 class="text-4xl font-bold mb-8">Manager List</h2>

    <?php
        // Запит до бази даних для отримання даних про менеджерів
        $sql = "SELECT * FROM manager ORDER BY manager_id ASC";  // Змінено ORDER BY
